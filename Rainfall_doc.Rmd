...
Here is a box plot comparison of the two datasets. The simulated Gamma data matches well with the actual rainfall data. A noteable exception is that the simulated data does have a maximum point of about 3 whereas the rainfall data only reaches values of about 2. However even with that point in the dataset, the quantiles match up well. 

#Wet vs Dry years

I began examining Wet vs Dry years by looking at a violin plot of the data. 
```{r}
ggvio
```
